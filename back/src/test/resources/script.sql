...
INSERT INTO USERS (first_name, last_name, admin, email, password)
VALUES ('Test', 'User', false, 'test@user.com', '$2a$10$.Hsa/ZjUVaHqi0tp9xieMeewrnZxrZ5pQRzddUXE/WjDu2ZThe6Iq');

INSERT INTO SESSIONS (name, description, date, teacher_id)
VALUES ('Yoga', 'Yoga session', '2025-02-03 10:00:00', 1),
       ('Pilates', 'Pilates session', '2025-03-02 11:00:00', 2);
